...
class ccpfr
{
    ...
    public static function list($params){
        $consulta = "SELECT * FROM tbl_pfr where estado=0 and eliminado=0 order by 1 desc";
        try {
            // Preparar sentencia
    ...
    public static function getbyid($params){
        $consulta = "SELECT * FROM tbl_pfr where estado=0 and eliminado=0 and id=?";
        try {
            // Preparar sentencia
            $comando = Database::getInstance()->getDb()->prepare($consulta);
    ...
    public static function insert($params){
		...
		$consulta="insert into tbl_pfr ($campos) values ($bind)";
    ...
    public static function update($params){
		...
		$consulta="update tbl_pfr set $campos  where id=?";
