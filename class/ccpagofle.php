...
class ccpagofle
{
    ...
    public static function list($params){
        $consulta = "SELECT * FROM tbl_pago_fle where estado=0 and eliminado=0 order by 1 desc";
        try {
            // Preparar sentencia
    ...
    public static function getbyid($params){
        $consulta = "SELECT * FROM tbl_pago_fle where estado=0 and eliminado=0 and idprog=?";
        try {
            // Preparar sentencia
            $comando = Database::getInstance()->getDb()->prepare($consulta);
    ...
    public static function getcolumns(){
        $consulta="DESCRIBE tbl_pago_fle";
    ...
    public static function insert($params){
        //print_r($params);exit;
        $columnasdata = ccpagofle::getcolumns();
		...
		$consulta="insert into tbl_pago_fle ($campos) values ($bind)";
    ...
    public static function update($params){
		...
		$consulta="update tbl_pago_fle set $campos  where eliminado=0 and  idprog=?";
