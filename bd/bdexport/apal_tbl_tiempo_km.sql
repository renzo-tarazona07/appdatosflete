...
--
-- Table structure for table `tbl_tiempo_km`
--

DROP TABLE IF EXISTS `tbl_tiempo_km`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_tiempo_km` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idprog` varchar(50) DEFAULT NULL,
  `fecha_tiempoliqui` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `tbl_tiempo_km`
--

LOCK TABLES `tbl_tiempo_km` WRITE;
/*!40000 ALTER TABLE `tbl_tiempo_km` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_tiempo_km` ENABLE KEYS */;
UNLOCK TABLES;
