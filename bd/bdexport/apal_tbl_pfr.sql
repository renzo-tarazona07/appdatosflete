...
--
-- Table structure for table `tbl_pfr`
--

DROP TABLE IF EXISTS `tbl_pfr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_pfr` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idgenerado` varchar(50) DEFAULT NULL,
  `fecha_prf` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `tbl_pfr`
--

LOCK TABLES `tbl_pfr` WRITE;
/*!40000 ALTER TABLE `tbl_pfr` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_pfr` ENABLE KEYS */;
UNLOCK TABLES;
