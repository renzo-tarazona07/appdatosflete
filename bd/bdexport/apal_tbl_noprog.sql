...
--
-- Table structure for table `tbl_noprog`
--

DROP TABLE IF EXISTS `tbl_noprog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_noprog` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idnoprog` varchar(50) DEFAULT NULL,
  `fecha_noprog` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `tbl_noprog`
--

LOCK TABLES `tbl_noprog` WRITE;
/*!40000 ALTER TABLE `tbl_noprog` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_noprog` ENABLE KEYS */;
UNLOCK TABLES;
