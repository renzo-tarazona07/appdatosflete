...
DROP TABLE IF EXISTS `tbl_drop`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_drop` (
  `id` int NOT NULL AUTO_INCREMENT,
  `fecha_drop` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `tbl_drop`
--

LOCK TABLES `tbl_drop` WRITE;
/*!40000 ALTER TABLE `tbl_drop` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_drop` ENABLE KEYS */;
UNLOCK TABLES;
